...
int main() {
    ...
    double E1 = 0.65 / 4;
    double E2 = 1. / 4;
    const Hamiltonian hamiltonian{Lx, Ly, nu, true, false};
    ...
    Timer t;
    // Simulation::dos(hamiltonian, static_cast<long int>(std::pow(2, 12)), output_path1);
    Simulation::ldos(hamiltonian, E1, 0.003, static_cast<long>(std::pow(2, 11)), output_path2);
    Simulation::ldos(hamiltonian, E2, 0.003, static_cast<long>(std::pow(2, 11)), output_path3);
